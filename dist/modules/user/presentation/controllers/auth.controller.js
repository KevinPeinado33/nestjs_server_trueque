...
let AuthController = exports.AuthController = class AuthController {
    constructor(loginUserProxy) {
        this.loginUserProxy = loginUserProxy;
    }
    async login(payload) {
...
exports.AuthController = AuthController = __decorate([
    ...
    __param(0, (0, common_1.Inject)(proxy_1.UserUseCaseProxyModule.LOGIN_USER_USECASE)),
    __metadata("design:paramtypes", [auth_1.LoginUseCase])
], AuthController);
